...
//		public static const COLLECTION_CREATED : String = "collection_create";
    public static const FETCH_COMPLETE : String = "fetch_complete";
    public static const PUT_COMPLETE : String = "put_complete";
    public static const DESTROY_COMPLETE : String = "destroy_complete";
    public static const POST_COMPLETE : String = "post_complete";
    public static const FAULT : String = "fault";
